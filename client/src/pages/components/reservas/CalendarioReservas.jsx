...
import { formatearFechaDDMMAAAA } from "../../utils/dateUtils"; // ✅ AGREGAR IMPORT  
...
export default function CalendarioReservas({    
  ...
  // ✅ MANTENER esta función para el formato corto del calendario  
  ...
  // ✅ NUEVA función para formato largo DD/MM/AAAA  
  ...
  const handleConfirmarReserva = () => {    
    if (fechaSeleccionada) {    
      onSolicitarReserva(fechaSeleccionada); // ✅ Envía el objeto Date, MisReservas.jsx lo convertirá  
            ...
            >    
              <div className="text-center">    
                <div className={`text-xs font-medium mb-1 ${    
                  ...
                  {formatearFechaCorta(dia).split(',')[0]}  
                </div>    
                ...
                <div className={`text-xs ${    
                  ...
                  {formatearFechaCorta(dia).split(',')[1]}  
                </div>    
              </div>    
              {esHoy && (    
