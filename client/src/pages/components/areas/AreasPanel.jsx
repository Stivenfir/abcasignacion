...
const handleAbrirPlanoEdicion = async (areaPiso, delimitacion = null) => {  
  setAreaSeleccionada(areas.find(a => a.IdArea === areaPiso.IdArea)?.IdArea);  
  setAreaPisoSeleccionada(areaPiso.IdAreaPiso);  
  setDelimitacionAEditar(delimitacion); // ✅ Guardar delimitación  
  ...
  // ✅ Nueva función para gestionar delimitaciones
  ...
  return (
    <div className="lg:col-span-2">
      ...
      {/* ✅ NUEVO: Modal de gestión de delimitaciones */}
      {modalGestion && (
        <GestionDelimitacionesModal
          areaPiso={modalGestion}
          area={areas.find((a) => a.IdArea === modalGestion.IdArea)}
          delimitaciones={delimitaciones}
          onEditarDelimitacion={handleAbrirPlanoEdicion} // ✅ Abre PlanoModal
          onEliminarDelimitacion={onEliminarDelimitacion} // ✅ Elimina delimitación
