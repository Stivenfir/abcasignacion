...
const cards = [
  {
    ...
    description: "Encuentra rápidamente un puesto disponible en tu piso.",
    icon: "🗺️",
  ...
  },
  {
    to: "/mis-reservas",
    title: "Mis reservas",
    description: "Reserva, revisa y cancela tus reservas desde aquí.",
    icon: "📋",
    ...
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      >
        ...
        <p className="text-gray-600 mt-1">
          Bienvenido. Elige una acción para comenzar rápidamente.
        </p>
      </motion.div>
